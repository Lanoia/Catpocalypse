...
from powerup import PowerUp, spawn_random_powerup, POWERUP_HEALTH, POWERUP_AMMO, POWERUP_SPEED, POWERUP_DAMAGE, POWERUP_WALL
                    ...
                    if (abs(bullet.x - enemy.x) < enemy.width // 2 + bullet.radius and
                        ...
                        if enemy.take_damage(bullet.damage):
                            ...
                            if random.random() < powerup_chance:
                                ...
                                powerup_type = random.randint(0, 4)  # Random type
